...
def main():
    #time vectors 
    t_trajectory = np.linspace(0, 100, 4001)
    ...
    amplitudes = [i*A_0 for i in np.arange(0.01, 0.11, 0.01)]
    ...
    plotting.plot_fibrosis_ratios(mFM_space, t_trajectory, t_separatrix, x_initial, start_point = 0, duration = 8, amplitude = 0, num_sim = num_sim, noise_type = noise_type,
                                standard_deviations = standard_deviations, poisson_lams = poisson_lams, gamma_means = gamma_means,
